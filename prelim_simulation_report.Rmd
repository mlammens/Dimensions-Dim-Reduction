...
We wanted to examine the effectiveness of the Curtis and Ghosh (2011) variable
selection algorithm using a simulated dataset. In this way, we 
know *a priori* the functional relationships between environmental conditions and
trait values. Because we are interested in understanding the effects of multi-collinearity
on the accuracy of the Curtis and Ghosh method, in simulating our new trait, we
purposely used a small number of environmental variables that were highly correlated 
...
for simulation scenario (1) above (i.e., three equal $\beta$ valeus). 
...
Below are historgrams of CG results for various simulations. Also included
